...
# as tuplas são imutáveis, ou seja, não podem ter os seus elementos alterados

# Criação e manipulação básica de uma ED do tipo tupla.

# tuplas – criação e manipulação básica
# tupla com 5 elementos
t1 = (10, 20, 30, 40, 50)
# para criar uma tupla com um único elemento,usa-se vírgula no final
t2 = (100,)
